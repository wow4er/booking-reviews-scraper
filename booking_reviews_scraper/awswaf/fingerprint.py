...
gpus = json.load(open(f"{dirname}/webgl.json"))

def get_fp(agent_version: int):
    ...
    fp = {
        ...
        "referrer": "",
        "userAgent": f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{agent_version}.0.0.0 Safari/537.36",
        "location": "",
        "webDriver": False,
        "capabilities": {
            "css": {
